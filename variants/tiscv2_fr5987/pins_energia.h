/*
  ...
  *	pins_energia.h
  *
  *	Pin definition functions for TISCv2 w/FR5987
  *		Copyright (c) 2015 Robert Wessels. All right reserved.
  *
  *     Contribution: Patrick Allison.
  *
  ***********************************************************************
  Derived from:
...
// The Energia link for the TISCv2 is pretty bare-bones.
// We only wanted UART0, and the JTAG pins.
// The JTAG pins are
// P1.0 UC_TCK (43)
// P1.1 UC_TMS (45)
// P1.2 UC_TDI (46)
